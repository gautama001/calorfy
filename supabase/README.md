...
5. Configure Auth redirect URLs for `calorfy://**` before enabling email confirmation, magic links or OAuth. For Expo Go beta testing also allow `exp://**`; remove that wildcard when beta testing ends.
