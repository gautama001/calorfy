  ...
  return (
    <ScrollView style={{ backgroundColor }} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      ...
      <View style={[styles.card, { backgroundColor: cardColor, borderColor }]}>
        ...
        <TouchableOpacity style={[styles.accountRow, { borderColor }]} onPress={() => router.push('/settings/privacy' as Href)}><Ionicons name="shield-checkmark-outline" size={20} color="#00A77D" /><Text style={[styles.accountRowText, { color: textColor }]}>{t('privacy_policy')}</Text><Ionicons name="chevron-forward" size={18} color={mutedColor} /></TouchableOpacity>
