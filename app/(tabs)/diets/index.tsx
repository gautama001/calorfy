...
export default function DietsScreen() {
  ...
  return (
    <ScrollView style={{ backgroundColor }} contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity activeOpacity={0.82} style={[styles.planCta, { backgroundColor: isDarkMode ? '#163A30' : '#E5F7F0', borderColor: isDarkMode ? '#2B5A4C' : '#BFE7D9' }]} onPress={() => router.push('/plan' as never)}>
